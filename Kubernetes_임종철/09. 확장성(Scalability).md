...
![HPA와 Cluster Autoscaler의 공존](./09. 확장성(Scalability)/kubernetes_00_HPA와 Cluster Autoscaler의 공존.jpg)[^출처]
...
![Metrics Adapter의 위치](./09. 확장성(Scalability)/kubernetes_01_MetricsAdapter의위치.jpg)[^출처]
